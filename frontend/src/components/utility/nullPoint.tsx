...
export default function NullPoint({pageUrl}: Props) {
        ...
        <div className="bg-gray-900 w-full py-20 px-6 lg:p-20">
            <div className="container relative">
                <div className="mx-auto text-center">
                    ...
                    <Text variant="light" size="lg" className="text-black-900 font-medium">We were not able to find anything related “{pageUrl}”</Text>
                </div>
